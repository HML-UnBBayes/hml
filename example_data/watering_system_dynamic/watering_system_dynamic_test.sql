CREATE DATABASE  IF NOT EXISTS `wateringsystem_dynamic_test` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `wateringsystem_dynamic_test`;
-- MySQL dump 10.13  Distrib 5.7.17, for Win64 (x86_64)
--
-- Host: localhost    Database: wateringsystem_dynamic_test
-- ------------------------------------------------------
